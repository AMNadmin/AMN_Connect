...
<div id="mobile-bottom-nav">
	<ul>
        <li>
            <a href="#all-activities" data-toggle="tab" class="">
        ...
        <li>
            <a href="#all-users" data-toggle="tab" class="">
        ...
        <li>
            <a href="#all-projects" data-toggle="tab" class="">
    ...
    <div class="modal-body">
    	<ul class="list-group">
            <li class="list-group-item">
               <a href="<? bloginfo( 'siteurl' ); ?>/admin-profile/" class="block" title="Admin Profile"><i class="fa fa-user"></i> Admin Profile</a>
            </li>
            <li class="list-group-item">
