   ...
   <div class="page-container">
      ...
      <div class="page-content">
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <ul class="page-breadcrumb breadcrumb">
                  ...
                  <li><? echo get_the_title($projID); ?></li>
                  <? } ?>
               </ul>
         ...
         <div class="row">  
            ...
            <? if(!isset($_GET['pid'])){ ?>
            <!-- START ALL PROJECTS PANE -->
            <div class="col-md-12 admin-control-pane" id="all-users">
                <h4><i class="fa fa-file-text"></i> Network Projects</h4>
                <? include( 'views/all-projects.php' ); ?>
            </div>
            <!-- END ALL PROJECTS PANE -->
            <? } else { ?>
                <? include( 'views/loop-projects.php' ); ?>
            <? } ?>
